...
public class PublishingConfig implements SettingsSection {
    @SettingMeta
    ...
    @SettingMeta(cls=ArrayList.class)
    private List<String> secondaryDomains = list();
    ...
    @SettingMeta(valBoolean = false)
    private Boolean redirectToPrimary = false;

    public String getEnv() {
        return env;
    }

    public PublishingConfig setEnv(String env) {
        this.env = env;
        return this;
    }
    ...
    public PublishingConfig setHosts(List<String> hosts) {
        this.hosts = hosts;
        return this;
    }
    ...
    public PublishingConfig setRedirectToSsl(Boolean redirectToSsl) {
        this.redirectToSsl = redirectToSsl;
        return this;
    }

    public Boolean getRedirectToPrimary() {
        return redirectToPrimary;
    }

    public PublishingConfig setRedirectToPrimary(Boolean redirectToPrimary) {
        this.redirectToPrimary = redirectToPrimary;
        return this;
    }

    public List<String> getSecondaryDomains() {
        return secondaryDomains;
    }

    public PublishingConfig setSecondaryDomains(List<String> secondaryDomains) {
