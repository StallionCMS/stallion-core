...
public class NoStash<T extends Model> extends StashBase<T> {
    ...
    public T mergeDetached(Long id, T obj) {
        // No local version, so no need to do anything
        return obj;
    }

    @Override
    public T mergeDetached(Long id, T obj, Class<Annotation> anno) {
    ...
    @Override
    public T mergeWithDefaults(T obj, Class<Annotation> anno) {
        return obj;
    }
