...
package io.stallion.dal;


import io.stallion.dal.base.*;
import io.stallion.dal.db.*;
import io.stallion.dal.file.*;
 ...
 *
 */
public class DalRegistry  implements Map<String, ModelController>  {
    ...
    private static DalRegistry _instance;
    ...
    public static DalRegistry load() {
        _instance = new DalRegistry();
        try {
    ...
    public void loadAndHydrate(String targetFolder, Settings settings) throws Exception {
        loadFileBasedDal(targetFolder, settings);
     ...
     * @throws Exception
     */
    private void loadFileBasedDal(String targetFolder, Settings settings) throws Exception {
        List<DalRegistration> registrations = new ArrayList<>();
    ...
    public DalRegistry registerDbModel(Class<? extends Model> model, Class<? extends ModelController> controller) {
     ...
     * @return
     */
    public DalRegistry registerDbModel(Class<? extends Model> model, Class<? extends ModelController> controller, boolean syncToMemory) {
     ...
     * @param registration
     */
    public void registerDal(DalRegistration registration) {
