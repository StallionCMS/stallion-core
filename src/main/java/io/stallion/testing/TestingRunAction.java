...
/**
 * This is never actually run via the command-line, but is constructed manually from
 * StallionApplication.loadForTests to load a test environment
 */
public class TestingRunAction implements StallionRunAction {
    @Override
