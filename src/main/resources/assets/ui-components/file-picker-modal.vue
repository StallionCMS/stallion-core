...
<template>
    <div class="file-picker-modal-vue">
        <modal-base ref="themodal" v-on:close="$emit('close')" :large="true" title="Select a File">
            <div slot="body">
                <div v-if="enableTabs">
                    <ul class="nav nav-tabs" role="tablist">        
                        <li v-if="showLibrary" role="presentation" v-bind:class="{active: tab==='chooser'}" @click="tab='chooser'"><a class="" href="javascript:;" >File Library</a></li>
                ...
                <div class="p">
                    <file-library-chooser  v-if="tab==='chooser'" @chosen="onChosen"></file-library-chooser>
                    <file-upload-target v-if="tab==='uploader'" @uploaded="onChosen"></file-upload-target>
                </div>
            </div>
            <div slot="footer">
