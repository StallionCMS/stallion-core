...
<template>
    <div class="file-library-chooser-vue">
        <st-data-table label="file" data-url="/st-user-uploads/library" browser-url-template="#" :columns="columns" :infinite-scroll="false"></st-data-table>
    </div>
</template>
