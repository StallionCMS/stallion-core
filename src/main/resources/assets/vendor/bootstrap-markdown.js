      ...
      [{
        ...
        data: [{
          ...
          icon: {
            ...
            fa: 'fa fa-bold',
              'fa-3': 'icon-bold',
              material: 'material-icons material-bold',
          ...
          icon: {
            ...
            fa: 'fa fa-italic',
              'fa-3': 'icon-italic',
              material: 'material-icons material-italic',
          ...
          icon: {
            ...
            fa: 'fa fa-header',
              'fa-3': 'icon-font',
              material: 'material-icons material-format-size',
        ...
        data: [{
          ...
          icon: {
            ...
            fa: 'fa fa-link',
              'fa-3': 'icon-link',
              material: 'material-icons material-link',
          ...
          icon: {
            ...
            fa: 'fa fa-picture-o',
              'fa-3': 'icon-picture',
              material: 'material-icons material-image',
        ...
        data: [{
          ...
          icon: {
              ...
              fa: 'fa fa-list',
              'fa-3': 'icon-list-ul',
              material: 'material-icons material-format-list-bulleted',
          ...
          icon: {
            ...
            fa: 'fa fa-list-ol',
              'fa-3': 'icon-list-ol',
              material: 'material-icons material-format-list-numbered',              
          ...
          icon: {
            ...
            fa: 'fa fa-code',
              'fa-3': 'icon-code',
              material: 'material-icons material-code',              
          ...
          icon: {
            ...
            fa: 'fa fa-quote-left',
              ...
              material: 'material-icons material-format-quote',
        ...
        data: [{
          ...
          icon: {
            ...
            fa: 'fa fa-search',
              'fa-3': 'icon-search',
              material: 'material-icons material-search',              
        ...
        fullscreenOn: {
          ...
          icon: {
            ...
            glyph: 'glyphicon glyphicon-fullscreen',
              ...
              material: 'material-icons material-fullscreen',              
